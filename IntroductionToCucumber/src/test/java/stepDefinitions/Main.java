...
WebDriver driver;
    ...
    public void open_google() {
        System.setProperty("webdriver.chrome.driver","C:\\Users\\hi.panchal\\Downloads\\chromedriver_win32\\chromedriver.exe");
...
driver.findElement(By.xpath("//*[@id=\"rso\"]/div[1]/div/div/div/div/div/div/div[1]/a/h3")).click();
    ...
    @Then("^extract text under service$")
    public void extract_text_under_service() throws InterruptedException {
String s = driver.findElement(By.xpath("//*[@id=\"11913\"]/div/section[1]/div/div/div/div/section/div/div[1]/div/section/div/div/div/div/div/div/p[1]")).getText();
